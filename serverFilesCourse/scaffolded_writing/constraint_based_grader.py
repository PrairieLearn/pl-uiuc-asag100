...
from shared_utils import QuestionData, grade_question_parameterized
from typing import Callable, Generic, List, Optional, Tuple, TypeVar, Type
...
class IncrementalConstraintGrader(Generic[SubmissionT]):
    ...
    def add_constraint(self, constraint: ConstraintFunctionT, partial_credit: float = 1.0) -> None:
